...
- [Nightshade](https://github.com/matthewjberger/nightshade): data-oriented Rust game engine with an advanced PBR renderer and custom render graph, built-in editor, rapier3d physics, kira audio, gltf asset loading, scene graph, object picking, and Steam integration. Runs natively on DX12/Metal/Vulkan and in-browser via WebGPU. [Live demo](https://matthewberger.dev/nightshade).
- [Nightshade Viewer](https://github.com/matthewjberger/nightshade-viewer): a glTF/GLB viewer built on Nightshade, with the engine running in a web worker via WebGPU and a Leptos UI for the scene tree, inspector, transform gizmos, animation playback, shading and PBR debug views, HDRI and sample-model browsers, and GPU picking. [Live demo](https://matthewberger.dev/nightshade-viewer/).
- [portfolio](https://github.com/matthewjberger/portfolio): personal portfolio site rendered live by Nightshade running in a web worker via WebGPU, with a Leptos UI scrolling over a 3D world: page scroll flies the camera between section vignettes, the pointer adds parallax, and a hidden physics game ships as an easter egg. All content lives in TOML embedded at compile time. [Live demo](https://matthewberger.dev/portfolio/).
