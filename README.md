...
- [frost](https://github.com/matthewjberger/frost): A data-oriented systems language with Odin-style syntax. Memory safety without a garbage collector or lifetimes, linear resources, generational handles, and a compiler written in itself.
